...
$MESS["INSTALL_LAST_MSG"] = "Now you can use the component \"Sections with elements\" in the visual editor.<br>Don't forget to reset the cache in the visual editor.<br>Enjoy using, command <a href='https://dev2fun.com'>dev2fun</a>";
